...
import 'package:ars_corpia/pages/history_page.dart';
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('Share our app!', style: TextStyle(color: textColor),),
              onTap: () {
                //share the application
            ...
            ListTile(
              ...
              title: const Text('Rate us', style: TextStyle(color: textColor),),
              onTap: () {
            ...
            ListTile(
              ...
              onTap: () {
                //send email report
                launchEmailIntent('sizibamthandazo@yahoo.com', 'ARS-CORPIA BUG REPORT');
              },
            ),
            // contact us
            ListTile(
              ...
              onTap: () {
                //Email intent
                launchEmailIntent('sizibamthandzo@yahoo.com', 'ARS-CORPIA CUSTOMER REACHING OUT');
              },
            ),
            // Sign out
            // ListTile(
